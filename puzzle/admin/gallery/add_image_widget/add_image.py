...
class Ui_AddImage(object):
    def setupUi(self, AddImage):
        if not AddImage.objectName():
            AddImage.setObjectName(u"AddImage")
        AddImage.resize(398, 222)
        self.gridLayoutWidget = QWidget(AddImage)
    ...
    def retranslateUi(self, AddImage):
        AddImage.setWindowTitle(QCoreApplication.translate("AddImage", u"\u0414\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u044f", None))
        self.label_2.setText(QCoreApplication.translate("AddImage", u"\u0418\u043c\u044f \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u044f", None))
        self.save_pushButton.setText(QCoreApplication.translate("AddImage", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c", None))
        self.choose_pushButton.setText(QCoreApplication.translate("AddImage", u"\u041e\u0431\u0437\u043e\u0440", None))
        self.path_label.setText(QCoreApplication.translate("AddImage", u"\u041f\u0443\u0442\u044c \u0434\u043e \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u044f", None))
    # retranslateUi
