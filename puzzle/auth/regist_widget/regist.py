...
class Ui_registWidget(object):
    def setupUi(self, registWidget):
        ...
        registWidget.resize(394, 337)
        self.gridLayoutWidget = QWidget(registWidget)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(10, 10, 379, 321))
        ...
        self.registWidgetGridLayout.addItem(self.horizontalSpacer2, 17, 2, 1, 1)
        ...
        self.registWidgetGridLayout.addWidget(self.password_label, 9, 2, 1, 1, Qt.AlignHCenter)

        self.verticalSpacer3 = QSpacerItem(20, 20, QSizePolicy.Minimum, QSizePolicy.Preferred)

        self.registWidgetGridLayout.addItem(self.verticalSpacer3, 12, 2, 1, 1)

        self.verticalSpacer4 = QSpacerItem(20, 20, QSizePolicy.Minimum, QSizePolicy.Expanding)

        self.registWidgetGridLayout.addItem(self.verticalSpacer4, 15, 2, 1, 1)

        self.verticalSpacer2 = QSpacerItem(20, 20, QSizePolicy.Minimum, QSizePolicy.Preferred)

        self.registWidgetGridLayout.addItem(self.verticalSpacer2, 7, 2, 1, 1)
        ...
        self.registWidgetGridLayout.addWidget(self.back_pushButton, 17, 1, 1, 1)
        ...
        self.registWidgetGridLayout.addWidget(self.regTitle_label, 1, 2, 1, 1)
        ...
        self.registWidgetGridLayout.addWidget(self.ok_pushButton, 17, 3, 1, 1)
        ...
        self.registWidgetGridLayout.addWidget(self.confirmPassword_lineEdit, 14, 2, 1, 1)

        self.loginLineEdit = QLineEdit(self.gridLayoutWidget)
        self.loginLineEdit.setObjectName(u"loginLineEdit")

        self.registWidgetGridLayout.addWidget(self.loginLineEdit, 6, 2, 1, 1)
        ...
        self.registWidgetGridLayout.addWidget(self.confirmPassword_label, 13, 2, 1, 1)

        self.password_lineEdit = QLineEdit(self.gridLayoutWidget)
        self.password_lineEdit.setObjectName(u"password_lineEdit")

        self.registWidgetGridLayout.addWidget(self.password_lineEdit, 11, 2, 1, 1)

        self.verticalSpacer1 = QSpacerItem(20, 20, QSizePolicy.Minimum, QSizePolicy.Preferred)

        self.registWidgetGridLayout.addItem(self.verticalSpacer1, 2, 2, 1, 1)
        ...
        self.registWidgetGridLayout.addWidget(self.login_label, 4, 2, 1, 1, Qt.AlignHCenter)
